...
$(document).ready(function () {
    ...
    $("#botonRegistroHorario").click(function () {
        $("#FormNoticiaFun").validate({
            ...
            submitHandler: function (form) {
                ...
                if (inicio === "Seleccione" || fin === "Seleccione") {
    ...
    $("#botonBuscarHorariosFun").bind("click", function () {
        listarCitasPorAtender();
    });

    function listarCitasPorAtender() {
        $("#FormCitasAtender").validate({
            rules: {
                dateListadoCitas: {required: true}
            },
            messages:
                    {
                        dateListadoCitas: "<span style='color:red'> ✘ </span>"
                    },

            submitHandler: function (form) {

                var datos = {
                    dateListadoCitas: $("#dateListadoCitas").val(),
