...
if (isset($_SESSION["Usuario"])) {
  ...
  include_once 'view/modulos/pestanas/cambiarContrasena.php';
        ...
        if (isset($_SESSION["Tipo"])) {
          ...
          if ($tipo == "Administrador") {
            echo '<ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="administrador_imagenes" id="Administrador_Imagenes" title="Imágenes"><ion-icon name="images"></ion-icon> Imágenes</a>
                    </li>
                  </ul>';
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
              ...
              if (isset($_SESSION["Tipo"])) {
                if ($tipo == "Usuario" || $tipo == "Funcionario") {
                  ...
                  <a class="nav-link opciones" data-toggle="modal" href="#modalCambiarContrasena" title="Cambiar Contraseña" id="headerContraseña">
                    <ion-icon name="lock"></ion-icon> Cambiar Contraseña
                  </a>';
                }
              }
              ?>
